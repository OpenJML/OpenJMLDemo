...
class GameGUI {
  ...
  public class MyPanel extends JPanel {
    ...
    public Game game;
    /*@ nullable */ BufferedImage playerImage;
    /*@ nullable */ BufferedImage wallImage;
    /*@ nullable */ BufferedImage crateImage;
    /*@ nullable */ BufferedImage crateMarkedImage;
    /*@ nullable */ BufferedImage  blankImage;
    /*@ nullable */ BufferedImage blankMarkedImage;
      ...
      for (int y = 0; y < game.board.ySize; y++) {
        for (int x = 0; x < game.board.xSize; x++) {
          ...
          if (game.player.position.equals (new Position (x, y))) {
            ...
            if (game.board.crate[x][y])
                  image = game.board.marked[x][y]? crateMarkedImage : crateImage;
            else if (game.board.ground[x][y])
                image = game.board.marked[x][y]? blankMarkedImage : blankImage;
            else
              image = wallImage;
          }

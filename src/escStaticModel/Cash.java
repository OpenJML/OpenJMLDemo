...
public class Cash {
   ...
   */
  public static int _total_cash; //@ in total_cash;
  ...
  //@ requires the_amount + _total_cash <= Integer.MAX_VALUE;
  //@ ensures amount == the_amount;
  //@ ensures !loaded;
  //@ ensures _total_cash == \old(_total_cash) + the_amount;
  //@ assignable total_cash;
